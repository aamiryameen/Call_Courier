...
export default class TaxScheduleMainList extends Component {
  constructor(props) {
    super(props);
  ...
  _renderButton = (text, onPress) => (
    <View style={{flexDirection: 'row', justifyContent: 'flex-end'}}>
      <TouchableOpacity onPress={onPress} style={{width: 230, height: 70}}>
  ...
  _renderModalContent = () => (
    <View style={styles.modalContent}>
      <Text style={{color: '#2b7de9', fontSize: 20, fontWeight: 'bold'}}>
        {translate('AddTaxSchedule')}
      </Text>
      <View style={{width: '90%', paddingTop: 10}}>
        <Text style={{marginLeft: 3, color: '#2b7de9'}}>
          {translate('ScheduleCode')}
        </Text>
        <View
          style={{
            flexDirection: 'row',
        ...
        <View>
          <Text style={{marginLeft: 3, color: '#2b7de9', marginTop: 4}}>
            {translate('EffectedDate')}
          </Text>
          <Dropdown
            baseColor="#2b7de9"
            textColor="#2b7de9"
        ...
        <Text style={{marginLeft: 3, color: '#2b7de9', marginTop: 10}}>
          {translate('TaxPercent')}
        </Text>
        ...
        <View style={{flexDirection: 'row', paddingLeft: 15, paddingLeft: 10}}>
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Text style={{color: 'white'}}>{translate('AddNewRow')}</Text>
            </TouchableOpacity>
          </View>
        </View>
      ...
      {this._renderButton(translate('SaveChanges'), () =>
        this.setState({visibleModal: null}),
      )}
      {this._renderButton(translate('Close'), () =>
        this.setState({visibleModal: null}),
      )}
    </View>
  );
    ...
    return (
      <View style={styles.container}>
        <View
          ...
          {this._renderButton(translate('AddTaxSchedule'), () =>
        ...
        <View style={{backgroundColor: '#2b7de9', height: 100}}>
          <View
            style={{
            ...
            <View style={{flexDirection: 'row', paddingRight: 10}}>
              <Text style={{color: 'white', fontSize: 16, marginStart: 5}}>
                {translate('StartPeriod')}
              </Text>
              <Text style={{color: 'white', fontSize: 16, marginStart: 2}}>
                :
              </Text>
              <Text
                style={{
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <Text style={{color: '#1b6bd4', marginLeft: 5}}>
                  {translate('TaxName')}
                </Text>
                <Text style={{color: '#1b6bd4', marginLeft: 2}}>:</Text>
                <Text style={{color: '#1b6bd4', marginLeft: 10}}>
                  {translate('AamirYameen')}
                </Text>
              </View>
              <View
                style={{flexDirection: 'row', justifyContent: 'flex-start'}}>
