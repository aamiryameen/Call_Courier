...
export default class SignIn extends Component {
  ...
  <TouchableOpacity style={[styles.buttonContainer, styles.signupButton]} onPress={() => this.props.navigation.navigate('dashboard')}>
        ...
        <TouchableOpacity onPress={() => this.onClickListener('sign_up')} >
          <Text style={{borderBottomWidth:1,borderBottomColor:"#1f71de",width:120,color:"#1f71de",}}>Forgot Password?</Text>
        </TouchableOpacity>
        </View>
    
  </View>
  <View style={{flexDirection:"column",justifyContent:"flex-end",flex:0.15}}>
        <TouchableOpacity onPress={() => this.props.navigation.navigate('SignUp')} >
          <Text style={{borderBottomWidth:1,borderBottomColor:"#1f71de",width:170,color:"#1f71de",}}>Don't have accoutn?SignUp</Text>
        </TouchableOpacity>
        </View>
      </View>
    );
