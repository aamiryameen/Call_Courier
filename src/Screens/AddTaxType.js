...
export default class AddTaxType extends Component {
    constructor(props) {
        super(props);
  ...
  _saveLang = async (country) => {
    ...
    _renderButton = (text, onPress) => (
        <View style={{ flexDirection: "row", justifyContent: "flex-end" }}>
            ...
            <TouchableOpacity onPress={onPress} style={{ width: 200, height: 70 }} >
    ...
    _renderModalContent = () => (
        <View style={styles.modalContent}>
            <Text style={{ color: "#2b7de9", fontSize: 20,fontWeight:"bold" }}>{translate("EditTaxType")}</Text>
            <View style={{width:"90%",paddingTop:10}}> 
            
            
               <Text style={{ marginLeft:3,color:"#2b7de9"}}>{translate("Name")}</Text>
            <View style={{flexDirection:"row",alignItems:"center",paddingLeft:15,
    height:45,width:270,backgroundColor:"white",marginBottom:20,borderWidth:0.7,borderColor:"#2b7de9",
      borderRadius:10}}>
    ...
    <Text style={{ marginLeft:3,color:"#2b7de9"}}>{translate("Description")}</Text>
            <View style={{flexDirection:"row",alignItems:"center",paddingLeft:15,
    height:45,width:270,backgroundColor:"white",marginBottom:20,borderWidth:0.7,borderColor:"#2b7de9",
      borderRadius:10}}>
...
borderBottomWidth={0}
        label={translate("SelectType")}
        data={data} />

   
<Text style={{ marginLeft:3,color:"#2b7de9",marginTop:10}}>{translate("Account")}</Text>
            <View style={{flexDirection:"row",alignItems:"center",paddingLeft:15,
    height:45,width:270,backgroundColor:"white",marginBottom:20,borderWidth:0.7,borderColor:"#2b7de9",
      borderRadius:10}}>
...
<View  />
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{ flexDirection: "row", justifyContent: "flex-end", alignItems: "flex-end" }}>
                    {this._renderButton(translate('AddTaxType'), () => this.setState({ visibleModal: 2 }))}
                </View>
  ...
  <ScrollView>
                    ...
                    <View style={{ backgroundColor: "#2b7de9", height:120, borderRadius: 10, marginLeft: 10, marginRight: 10 }}>


<View style={{ flexDirection: "column", justifyContent: "center", paddingTop: 20, marginLeft: 20, marginRight: 20 }} >
    <View style={{ flexDirection: "row", paddingRight: 10 }}>
        <Text style={{ color: "#2b7de9", fontSize: 16, marginStart: 5,color:"white" }}>
            {translate("Name")}</Text>
        <Text style={{ color: "#2b7de9", fontSize: 16, marginStart: 2 ,color:"white" }}>:</Text>
        <Text style={{ color: "#4d4e4f", fontSize: 16, marginStart: 5, marginEnd: 5,color:"white"  }}>  {translate("AamirYameen")}</Text>
    </View>
    <View style={{ flexDirection: "row", paddingRight: 10 }}>
        <Text style={{ color: "#2b7de9", fontSize: 16, marginStart: 5 ,color:"white" }}>
            {translate("Type")}</Text>
        <Text style={{ color: "#2b7de9", fontSize: 16, marginStart: 2 ,color:"white" }}>:</Text>
        <Text style={{ color: "#4d4e4f", fontSize: 16, marginStart: 5, marginEnd: 5 ,color:"white" }}>{translate("GST")}</Text>
    ...
    <View style={{ flexDirection: "row", paddingRight: 10 }}>
        ...
        <Text style={{ color: "#2b7de9", fontSize: 16, marginStart: 2,color:"white"  }}>:</Text>
        <Text style={{ color: "#4d4e4f", fontSize: 16, marginStart: 5, marginEnd: 5,color:"white"  }}>{translate("Plastic Bags Sales A/C")}</Text>
...
{/* Blue Box style 2 */}
<View style={{ backgroundColor: "#2b7de9", height:120, borderRadius: 10, marginLeft: 10, marginRight: 10 ,marginTop:10}}>
