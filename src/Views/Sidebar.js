...
<DashboardScreen/>    }
  ...
  renderContent(section) {
    ...
    if (section.title == "Account Defination") {
      return (
        <View >
          ...
          <TouchableOpacity onPress={() => this.props.parentContext.setScreen("ApprovalDashboard")} style={{ flexDirection: "row" }}>
            <Image source={require('../Images/dot.png')} style={{ height: 30, width: 30 }} />
            <Text style={styles.tappableSubLink}>{translate('ApprovedDashboard')}</Text></TouchableOpacity>
          <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => this.props.parentContext.setScreen("ApprovalDashboard")}>
            <Image source={require('../Images/dot.png')} style={{ height: 30, width: 30 }} />
            <Text style={styles.tappableSubLink}>{translate('AccountsDashboard')}</Text></TouchableOpacity>
          <TouchableOpacity style={{ flexDirection: "row" }}  onPress={() => this.props.parentContext.setScreen("ChartOfAccount")} >
            <Image source={require('../Images/dot.png')} style={{ height: 30, width: 30 }} />
            <Text style={styles.tappableSubLink}>{translate('ChartOfAccount')}</Text></TouchableOpacity>
          <TouchableOpacity style={{ flexDirection: "row" }}  onPress={() => this.props.parentContext.setScreen("OpeningBalancesList")}>
            <Image source={require('../Images/dot.png')} style={{ height: 30, width: 30 }} />
            <Text style={styles.tappableSubLink}>{translate('OpeningBalances')}</Text></TouchableOpacity>
          <TouchableOpacity style={{ flexDirection: "row" }}  onPress={() => this.props.parentContext.setScreen("TaxScheduleMainList")}>
            <Image source={require('../Images/dot.png')} style={{ height: 30, width: 30 }} />
            <Text style={styles.tappableSubLink}>{translate('TaxScheduleMain')}</Text></TouchableOpacity>
          <TouchableOpacity style={{ flexDirection: "row" }}  onPress={() => this.props.parentContext.setScreen("AddTaxType")} >
            <Image source={require('../Images/dot.png')} style={{ height: 30, width: 30 }} />
            <Text style={styles.tappableSubLink}>{translate('TaxTypes')}</Text></TouchableOpacity>
          <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => this.props.parentContext.setScreen("BankDefinationList")}>
            <Image source={require('../Images/dot.png')} style={{ height: 30, width: 30 }} />
    ...
    if (section.title == "Accounts Transaction") {
      return (
        <View>
          <TouchableOpacity style={{ flexDirection: "row" }}     onPress={() => this.props.parentContext.setScreen("PaymentVoucherDetail")} >
            <Image source={require('../Images/dot.png')} style={{ height: 30, width: 30 }}
      />
      <Text style={styles.tappableSubLink}>{translate("PaymentVoucher")}</Text></TouchableOpacity>
          <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => this.props.parentContext.setScreen("ReceiptVoucherDetail")}>
            <Image source={require('../Images/dot.png')} style={{ height: 30, width: 30 }} />
            <Text style={styles.tappableSubLink}>{translate("ReceiptVoucher")}</Text></TouchableOpacity>
          <TouchableOpacity style={{ flexDirection: "row" }}  onPress={() => this.props.parentContext.setScreen("JournalCreditVoucher")}>
            <Image source={require('../Images/dot.png')} style={{ height: 30, width: 30 }} />
            <Text style={styles.tappableSubLink}>{translate("CreditVoucher")}</Text></TouchableOpacity>
          <TouchableOpacity style={{ flexDirection: "row" }}    onPress={() => this.props.parentContext.setScreen("JournalDebitVoucher")}>
            <Image source={require('../Images/dot.png')} style={{ height: 30, width: 30 }} />
            <Text style={styles.tappableSubLink}>{translate("JournalDebitVoucher")}</Text></TouchableOpacity>
          <TouchableOpacity style={{ flexDirection: "row" }}  onPress={() => this.props.parentContext.setScreen("ContraVoucherDetail")}>
      ...
      <View style={styles.container}>
        <ScrollView contentContainerStyle={{}}>
          ...
          <View style={{ backgroundColor: "#0e64d6" }}>
            ...
            <Text style={{ color: "#fff", marginTop: 20, paddingStart: 10,paddingEnd:10 }}>{translate("name")}</Text>

            <Text style={{ color: "#fff", paddingStart: 10,paddingEnd:10, marginBottom: 5 }}> aamiryameen0652@gmail.com</Text>
          </View>
