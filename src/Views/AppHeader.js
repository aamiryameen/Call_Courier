    ...
    return (
      <View style={styles.Headerstyle}>
        <View style={{ backgroundColor: constants.skyBlue, flexDirection: 'row', padding: 10,}} >
          ...
          <View style={{ flex: 1, marginLeft: 8, marginTop: 3}}>
          ...
          <Body style={{ flex: 8, marginBottom: 2 }}>
            <Title
              style={{
          ...
          <Text style={{justifyContent:"center",alignItems:"center",marginTop:10}}>{this.props.headerTitle}</Text>    
            </Title>
          </Body>
        </View>
      </View>
